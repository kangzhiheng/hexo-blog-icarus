...
var repoIssuesUrl = "https://api.github.com/repos/adoredee/adoredee.github.io/issues";
// 对应仓库 clientId、clientSecret 关于这两个参数的安全问题，查看 https://removeif.github.io/2019/09/19/博客源码分享.html#1-热门推荐，最新评论：
var clientId = "63ea86b104bd9a73070a";
var clientSecret = "9d66cbaf6cf4e5d6400f0d081883eb9dc60d987e";
...
$(document).ready(setTimeout(function () { // 延迟1s执行，保证其余的先加载
        ...
        console.log("~~~~记得有时间多来看看哦，https://adoredee.github.io/")
    }
    ,
    500
))
